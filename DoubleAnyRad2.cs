...
namespace DoubleAnyRad2 {
    public class DoubleAnyRad2 : Mod, ITogglableMod, IMod, Modding.ILogger {
        ...
        public static global::DoubleAnyRad2.DoubleAnyRad2 Instance { get; private set; }
        ...
        public static void CreatePool(On.ObjectPool.orig_CreatePool orig, GameObject prefab, int initialPoolSize) {
            if (prefab.name == "Radiant Nail") {
                orig(prefab, 800);
            } else {
